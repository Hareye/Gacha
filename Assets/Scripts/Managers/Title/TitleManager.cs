...
public class TitleManager : MonoBehaviour
{
    ...
    private IEnumerator registerProcess(string email, string password)
    {
        ...
        IEnumerator registerCoroutine = ServerManager.instance.sendRequest(endpoints.register, list);
    ...
    private IEnumerator loginProcess(string email, string password, bool rememberMe)
    {
        ...
        IEnumerator loginCoroutine = ServerManager.instance.sendRequest(endpoints.login, list);
    ...
    private IEnumerator rememberProcess(string email)
    {
        ...
        IEnumerator rememberTokenCoroutine = ServerManager.instance.sendRequest(endpoints.rememberToken, list);
        ...
        } else
        {
            ...
            PlayerPrefs.SetString("rememberToken", status);
            PlayerPrefs.Save();
        }
    }
    ...
    private IEnumerator authProcess(string email)
    {
        ...
        IEnumerator authTokenCoroutine = ServerManager.instance.sendRequest(endpoints.authToken, list);
        ...
        else
        {
            ...
            AuthManager.instance.authToken = status;

            // For dev work to test individual screens
            PlayerPrefs.SetString("authToken", status);
            PlayerPrefs.Save();
        }
    }
    ...
    private IEnumerator resetProcess(string email)
    {
        ...
        IEnumerator resetCoroutine = ServerManager.instance.sendRequest(endpoints.resetPassword, list);
    ...
    private IEnumerator verifyRememberProcess(string rememberToken)
    {
        var list = new List<KeyValuePair<string, string>>()
        {
            new KeyValuePair<string, string>("rememberToken", rememberToken),
        };

        IEnumerator verifyRememberCoroutine = ServerManager.instance.sendRequest(endpoints.verifyRememberToken, list);
